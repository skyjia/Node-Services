...
IF "%1" == "email-service" (
	...
	node %EMAIL_SERVERICE_FOLDER%\www.js --config %CURRENT_DIR%\Service.Email_dev.yml
...
IF "%1" == "session-service" (
	...
	node %SESSION_SERVICE_FOLDER%\www.js --config %CURRENT_DIR%\Service.Session_dev.yml
...
IF "%1" == "content-service" (
	...
	node %CONTENT_SERVICE_FOLDER%\www.js --config %CURRENT_DIR%\Service.Content_dev.yml
